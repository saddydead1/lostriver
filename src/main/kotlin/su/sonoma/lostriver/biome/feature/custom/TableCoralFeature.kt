...
class TableCoralFeature(p_66768_: Codec<ProbabilityFeatureConfiguration>) :
    ...
    override fun place(p_160318_: FeaturePlaceContext<ProbabilityFeatureConfiguration?>): Boolean {
        val blockstate = ModBlocks.TABLECORAL.get().defaultBlockState()
        val blockstate1 = ModBlocks.ROYALBLOCK.get().defaultBlockState()
            ...
            if (blockstate.canSurvive(worldgenlevel, blockpos1)) {
                if (flag1) {
                    ...
                    if (worldgenlevel.getBlockState(blockpos2).`is`(Blocks.WATER)) {
                        ...
                        worldgenlevel.setBlock(blockpos.below(), blockstate1, 2)
                        worldgenlevel.setBlock(blockpos.below().north(), blockstate1, 2)
                        worldgenlevel.setBlock(blockpos.below().north(), blockstate1, 2)
