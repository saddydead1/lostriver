...
class HighOxygenTankArmorItem(armorMaterial: Holder<ArmorMaterial?>, type: Type?, properties: Properties?) :
    ArmorItem(armorMaterial, type, properties), GeoItem {
    private val cache: AnimatableInstanceCache = GeckoLibUtil.createInstanceCache(this)

    val oxygenCount = 135.0
        ...
        consumer.accept(object : IClientItemExtensions {
            ...
            override fun getHumanoidArmorModel(
                ...
                if (this.renderer == null) {
                    this.renderer = HighOxygenTankRenderer()
                }
